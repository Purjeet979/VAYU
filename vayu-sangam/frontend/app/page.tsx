    ...
    <div className="flex flex-col items-center">
      <section className="w-full max-w-6xl mx-auto px-6 py-20 md:py-24 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link href="/forecast" className="px-8 py-4 rounded-xl bg-teal-600 hover:bg-teal-500 text-white font-semibold transition-all flex items-center justify-center gap-2 hover:shadow-[0_0_20px_rgba(20,184,166,0.3)]">
      ...
      <section className="w-full max-w-6xl mx-auto px-6 mb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {questions.map((item) => (
            <Link key={item.q} href={item.href} className="group p-6 rounded-2xl bg-panel border border-panelBorder hover:border-teal-500/50 transition-colors flex flex-col justify-between h-full shadow-md">
